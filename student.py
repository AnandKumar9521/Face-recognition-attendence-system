...
class student:
    def __init__(self, root):
        ...
        img = Image.open(
            r"D:\anand\Desktop\Face recognition attendance system\college_images\bbb.png")
        ...
        img1 = Image.open(
            r"D:\anand\Desktop\Face recognition attendance system\college_images\ccc.jpg")
        ...
        img2 = Image.open(
            r"D:\anand\Desktop\Face recognition attendance system\college_images\smart-attendance.jpg")
        ...
        img3 = Image.open(
            r"D:\anand\Desktop\Face recognition attendance system\college_images\wp2551980.jpg")
        ...
        img_left = Image.open(
            r"D:\anand\Desktop\Face recognition attendance system\college_images\AdobeStock_303989091.jpeg")
        ...
        dep_combo["values"] = ("select department", "CSE", "IT", "ECE", "EE")
        dep_combo.current(0)
        ...
        studentID_entry = ttk.Entry(class_student_frame, textvariable=self.var_id, width=20, font=(
        ...
        studentName_entry = ttk.Entry(
            class_student_frame, textvariable=self.var_name, width=20, font=("times new roman", 12, "bold"))
        ...
        email_label = Label(class_student_frame, text="E-mail",
        ...
        phone_no_entry = ttk.Entry(class_student_frame, textvariable=self.var_phone, width=20, font=(
            "times new roman", 12, "bold"))
        ...
        take_photo_btn = Button(btn_frame1, text="Take photo",command=self.generate_dataset, width=39, font=(
            "times new roman", 12, "bold"), bg="blue", fg="white")
        take_photo_btn.grid(row=0, column=0)

        update_photo_btn = Button(btn_frame1, text="Update photo", width=39, font=(
            "times new roman", 12, "bold"), bg="blue", fg="white")
        ...
        img_right = Image.open(
            r"D:\anand\Desktop\Face recognition attendance system\college_images\gettyimages-1022573162.jpg")
        ...
        if self.var_dep.get() == "select department" or self.var_name.get() == "" or self.var_id.get() == "":
            ...
            try:
                conn = mysql.connector.connect(
                    host="localhost", username="root", password="anand@123", database="face_recognizer")
            ...
            try:
                ...
                if update > 0:
                    conn = mysql.connector.connect(
                        host="localhost", username="root", password="anand@123", database="face_recognizer")
                    my_cursor = conn.cursor()
                    my_cursor.execute("update student SET student.Dep=%s,student.course=%s,student.Year=%s,student.semester=%s,student.name=%s,student.div=%s,student.roll=%s,student.gender=%s,student.dob=%s,student.email=%s,student.phone=%s,student.address=%s,student.teacher=%s,student.photosample=%s where id=%s", (
    ...
    def reset_data(self):
        self.var_dep.set("select departmrnt")
    ...
    def generate_dataset(self):
        if self.var_dep.get()=="select department" or self.var_name.get()=="" or self.var_id.get()=="":
           messagebox.showerror("Error","All feilds are required",parent=self.root)
            ...
            try:
                conn=mysql.connector.connect(host="localhost",username="root",password="anand@123",database="face_recognizer")
                my_cursor=conn.cursor()
                my_cursor.execute("select * from student")
